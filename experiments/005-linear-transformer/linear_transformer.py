...
#     shift_tokens = False            # add single token shifting, for great improved convergence
# )
model = LinearTransformer(vocab_size, dim, model).to(device)
train_path = f"/home/bbadger/Desktop/fineweb-edu-tokenized-test-c512"
test_path = f"/home/bbadger/Desktop/fineweb-edu-tokenized-test-c512"
>>>>>>> 3d51e4b (fixes)
print (model)

# a = torch.tensor([[0, 1, 2]]).to(device)
# b = torch.tensor([[0, 1, 3]]).to(device)
# a_out = model(a, attention_mask=None, labels=a)
# b_out = model(b, attention_mask=None, labels=a)
# print (a_out, b_out)
...
=======
output_dir = '/home/bbadger/Desktop/fineweb_linear_transformer_test'
>>>>>>> 3d51e4b (fixes)
