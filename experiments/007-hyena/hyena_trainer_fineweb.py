...
if __name__ == "__main__":
    ...
    #print (model.forward(a, labels=a))
    #print (model.forward(b, labels=b))
    ...
    training_arguments = transformers.TrainingArguments(
        ...
        bf16=True,
        eval_strategy="steps",
        output_dir=f"{checkpoint_root}/fineweb_hyena_512_n16_c1024_b32x2",
        optim="adamw_torch",
    ...
    model.train()
    trainer.train()
    #trainer.train(f'{checkpoint_root}/fineweb_hyena_1024_n16_b32x2' + '/checkpoint-80000')
